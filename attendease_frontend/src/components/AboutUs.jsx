...
export default function AboutUs() {
  return (
    <div className="flex min-h-screen bg-white px-6 py-10 text-gray-800">
      ...
      <div className="space-y-12 flex-1">
        ...
        {/* Origin Story */}
        <motion.div
          className="bg-purple-100 p-6 rounded-2xl shadow-md"
        ...
        >
          ...
          <div className="italic text-sm text-purple-700 bg-purple-200 mt-4 p-3 rounded-xl w-fit">
        ...
        {/* Vision Statement */}
        <motion.div
          className="bg-yellow-50 p-6 rounded-2xl shadow-md"
          initial={{ opacity: 0, x: -30 }}
          whileInView={{ opacity: 1, x: 0 }}
        ...
        >
          ...
          <div className="italic text-sm text-green-700 bg-green-100 mt-4 p-3 rounded-xl w-fit">
